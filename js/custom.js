...
// LOGIN SECTION START
function submit(){
let loginSection =  document.getElementById("login-section"); //login Name and Pass
let accountSection =  document.getElementById("account-section"); //Bank lenden
...
if ( userName == admin && userPassword == adminPass ) {
    ...
    accountSection.style.display="block"; // account section show korbe
